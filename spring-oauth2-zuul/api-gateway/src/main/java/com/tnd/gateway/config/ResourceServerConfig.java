package com.tnd.gateway.config;
...
public class ResourceServerConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/uaa/**", "/login", "/token").permitAll().anyRequest().authenticated()
                .and()
                .csrf().disable()
    ...
    private AuthenticationManager oauthAuthenticationManager() {
        ...
        oAuth2AuthenticationManager.setResourceId("api-gateway");
